import{n as $,j as n,a as w,r as K,L as Q,G as U,g as V,A as Y}from"./index-cd2ae4f4.js";import{c as F}from"./index-85b66e65.js";const ee=$.div`
	position: fixed;
	width: 100%;
	left: 50%;
...
`,se=()=>n.jsx(oe,{children:n.jsx(ie,{children:Array.from({length:1}).map((a,i)=>n.jsxs("section",{children:[n.jsx("h1",{children:"contact person for order merchandise :"}),F.map((h,o)=>n.jsx("div",{children:n.jsx(Q,{to:h.cp,children:h.name})},o)),n.jsx("h1",{children:"harmony vol#2"})]},i))})}),le=$.main`
	...
	justify-content: center;
	padding: 1rem;
`,ue=()=>n.jsxs(le,{children:[n.jsx(U,{styles:V}),n.jsx(ne,{}),n.jsx(Y,{}),n.jsx(se,{})]});export{ue as Default};
