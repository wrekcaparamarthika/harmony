import{n as $,j as e,a as w,r as K,c as Q,L as U,G as V,g as Y,A as F}from"./index-8e2f833e.js";const ee=$.div`
	position: fixed;
	width: 100%;
	left: 50%;
...
`,se=()=>e.jsx(oe,{children:e.jsx(ie,{children:Array.from({length:1}).map((a,i)=>e.jsxs("section",{children:[e.jsx("h1",{children:"contact person for order merchandise :"}),Q.map((h,o)=>e.jsx("div",{children:e.jsx(U,{to:h.cp,children:h.name})},o)),e.jsx("span",{}),e.jsx("h1",{children:"harmony vol#2"}),e.jsx("span",{}),e.jsx("h1",{children:"naff"})]},i))})}),le=$.main`
	display: flex;
	flex-direction: column;
	align-items: center;
	justify-content: center;
	padding: 1rem;
`,de=()=>e.jsxs(le,{children:[e.jsx(V,{styles:Y}),e.jsx(ne,{}),e.jsx(F,{opacity:"100%"}),e.jsx(se,{})]});export{de as Default};
