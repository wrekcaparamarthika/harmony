const contactPerson = [
	{
		name: 'suralaga',
		cp: 'https://api.whatsapp.com/send/?phone=%2B6281239277187&text&type=phone_number&app_absent=0',
	},
	{
		name: 'devani rata',
		cp: 'https://api.whatsapp.com/send/?phone=%2B6287758706555&text&type=phone_number&app_absent=0',
	},
];
const latarText = {
